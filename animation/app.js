...
const ctx = canvas.getContext("2d"); //cecie est le context '2D' qui permet de creer lignes,cercle ect//
...
class Particle {
	...
	draw() {
		...
		ctx.fill();
	} //permet de creer les dots//
	update() {
		//methode qui permet de faire bouger les particles
		if (this.x > canvas.width || this.x < 0) {
			this.directionX = -this.directionX; //va changer la direction une fois atteinte
